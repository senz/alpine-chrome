# ghcr.io/senz/alpine-chrome with docker-compose

Here is an example with docker-compose on how to launch and use `ghcr.io/senz/alpine-chrome` calling a `nginx` page in another container.
...
You may change the `ghcr.io/senz/alpine-chrome` image you want to use modifying the line 10 in `docker-compose.yml`.
